  ...
  try {
    ...
    function wireMapSearch() {
      ...
      function doSearch() {
        ...
        fetch(amapUrl, { signal: ctrl.signal })
          .then(function(r) { clearTimeout(timer); return r.json(); })
          .then(function(data) { return parseAmap(data); })
          ...
          .then(function(items) {
            ...
            return fetch(hereUrl, { signal: ctrl2.signal })
              .then(function(r) { clearTimeout(t2); return r.json(); })
              .then(function(hData) { return parseHere(hData); })
              .catch(function() { return []; });
          })
          .then(function(items) {
